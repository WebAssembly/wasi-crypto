...
| **`Type::Variant` (Enum style)**        | `TypeDef::variant(...)`   | Custom map to variant cases if items contain data, or simple enums if values are empty.                                                     |
...
| **Version constants**                   | `variant`                                 |                                                                                                                                                                                         |
| **`Variant`** without data              |                                           |                                                                                                                                                                                         |
| `type ... = handle`                     | `resource`                                | This required manually adding borrowing where required                                                                                                                                  |
| **Imports**                             | `use use wasi-ephemeral-crypto-common.{}` | This was done manually and verified using:                                                                                                                                              |
